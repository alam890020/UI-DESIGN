...
$rows = $wpdb->get_results( "SELECT * FROM {$p}staff_leaves ORDER BY id DESC LIMIT 100" );
?>
<div class="sms-page">
    <?php SMS_Helper::page_header( 'Staff Leaves', 'Leave applications', 'clipboard' ); ?>
    <div class="sms-card">
        <div class="sms-card-head"><div class="sms-card-title"><?php echo SMS_Icons::svg('list',18); ?> Staff Leaves</div></div>
