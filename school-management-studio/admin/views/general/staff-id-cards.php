...
?>
<div class="sms-page">
    <?php SMS_Helper::page_header( 'Staff ID Cards', 'Staff card printing', 'badge' ); ?>
    <div class="sms-card">
        <div class="sms-card-head"><div class="sms-card-title"><?php echo SMS_Icons::svg('list',18); ?> Staff ID Cards</div></div>
