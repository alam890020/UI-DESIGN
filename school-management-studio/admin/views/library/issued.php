...
$rows = $wpdb->get_results( "SELECT * FROM {$p}books_issued ORDER BY id DESC LIMIT 100" );
?>
<div class="sms-page">
    <?php SMS_Helper::page_header( 'Books Issued', 'Borrowing', 'list' ); ?>
    <div class="sms-card">
        <div class="sms-card-head"><div class="sms-card-title"><?php echo SMS_Icons::svg('list',18); ?> Books Issued</div></div>
                ...
                <?php if ( $rows ) : foreach ( $rows as $r ) : ?>
                    <tr>
                        ...
                        <td><div class="sms-row-actions">
                            ...
                            <a href="#" class="del" data-entity="book" data-id="<?php echo (int) $r->id; ?>"><?php echo SMS_Icons::svg('trash',14); ?></a>
                        </div></td>
                    </tr>
                <?php endforeach; else : ?>
