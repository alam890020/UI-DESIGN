...
?>
<div class="sms-page">
    <?php SMS_Helper::page_header( 'Support Tickets', 'Helpdesk', 'ticket' ); ?>
    <div class="sms-card">
        <div class="sms-card-head"><div class="sms-card-title"><?php echo SMS_Icons::svg('list',18); ?> Support Tickets</div></div>
                ...
                <?php if ( $rows ) : foreach ( $rows as $r ) : ?>
                    <tr>
                        ...
                        <td><div class="sms-row-actions">
                            ...
                            <a href="#" class="del" data-entity="ticket" data-id="<?php echo (int) $r->id; ?>"><?php echo SMS_Icons::svg('trash',14); ?></a>
                        </div></td>
                    </tr>
                <?php endforeach; else : ?>
