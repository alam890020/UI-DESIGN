...
?>
<div class="sms-page">
    <?php SMS_Helper::page_header( 'Income', 'Revenue tracking', 'chart-line' ); ?>
    <div class="sms-card">
        <div class="sms-card-head"><div class="sms-card-title"><?php echo SMS_Icons::svg('list',18); ?> Income</div></div>
