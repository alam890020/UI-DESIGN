...
$rows = $wpdb->get_results( "SELECT * FROM {$p}invoices ORDER BY id DESC LIMIT 100" );
?>
<div class="sms-page">
    <?php SMS_Helper::page_header( 'Invoices', 'All invoices', 'invoice' ); ?>
    <div class="sms-card">
        <div class="sms-card-head"><div class="sms-card-title"><?php echo SMS_Icons::svg('list',18); ?> Invoices</div></div>
