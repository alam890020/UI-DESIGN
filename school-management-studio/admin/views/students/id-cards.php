...
?>
<div class="sms-page">
    <?php SMS_Helper::page_header( 'Student ID Cards', 'Generate cards', 'card' ); ?>
    <div class="sms-card">
        <div class="sms-card-head"><div class="sms-card-title"><?php echo SMS_Icons::svg('list',18); ?> Student ID Cards</div></div>
