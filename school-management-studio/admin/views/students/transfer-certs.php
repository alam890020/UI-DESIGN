...
$rows = $wpdb->get_results( "SELECT * FROM {$p}students ORDER BY id DESC LIMIT 100" );
?>
<div class="sms-page">
    <?php SMS_Helper::page_header( 'Transfer Certificates', 'TC issuance', 'send' ); ?>
    <div class="sms-card">
        <div class="sms-card-head"><div class="sms-card-title"><?php echo SMS_Icons::svg('list',18); ?> Transfer Certificates</div></div>
